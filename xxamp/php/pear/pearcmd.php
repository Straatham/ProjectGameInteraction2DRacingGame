...
if ('C:\Users\carlo\OneDrive\Bureaublad\ProjectGameInteraction2DRacingGame\xxamp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\carlo\OneDrive\Bureaublad\ProjectGameInteraction2DRacingGame\xxamp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
